<%-- 
    Document   : pageheader
    Created on : Apr 27, 2018, 4:02:04 PM
    Author     : elwyn
--%>
...
<link rel="shortcut icon" href="<c:url value = "/resources/images/hos.png"></c:url>" />
    ...
    <!-- NProgress -->
    <link href="<c:url value="/resourcesvendors/nprogress/nprogress.css"></c:url>" rel="stylesheet">
    <!-- iCheck -->
    ...
    <!-- added while addDoctor -->
    <!-- bootstrap-wysiwyg -->
    <link href="<c:url value="/resources/vendors/google-code-prettify/bin/prettify.min.css"></c:url>" rel="stylesheet">
    <!-- Select2 -->
    <link href="<c:url value="/resources/vendors/select2/dist/css/select2.min.css"></c:url>" rel="stylesheet">
    <!-- Switchery -->
    <link href="<c:url value="/resources/vendors/switchery/dist/switchery.min.css"></c:url>" rel="stylesheet">
    <!-- starrr -->
    <link href="<c:url value="/resources/vendors/starrr/dist/starrr.css"></c:url>" rel="stylesheet">
    <!-- added while addDoctor -->
